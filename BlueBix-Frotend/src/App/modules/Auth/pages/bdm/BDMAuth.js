      ...
      >
        ...
        <div className="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
          ...
          <div className="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
            <Switch>
              {<Redirect exact={true} from="/auth/bdm/" to="/auth/login" />}
              {<Redirect exact={true} from="/auth/bdm/login" to="/auth/login" />}
              {/* <ContentRoute path="/auth/bdm/login" component={Login} />
              <ContentRoute
                path="/auth/bdm/forgot-password"
                component={ForgotPassword}
              />
              <ContentRoute path="/auth/bdm/logout" component={Logout} /> */}
              <Route
                path="/auth/bdm/reset-password/:id"
