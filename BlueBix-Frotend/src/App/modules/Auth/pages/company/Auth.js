          ...
          <div className="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
            <Switch>
              ...
              }
              {
                <Redirect
                  exact={true}
                  from="/auth/company/login"
                  to="/auth/login"
                ></Redirect>
              }
              {/* <ContentRoute path="/auth/company/login" component={Login} />
              <ContentRoute
                path="/auth/company/registration"
                component={Registration}
              />
              <ContentRoute
                path="/auth/company/forgot-password"
                component={ForgotPassword}
              />
              <ContentRoute path="/auth/company/logout" component={Logout} /> */}
              <Route
                path="/auth/company/reset-password/:id"
