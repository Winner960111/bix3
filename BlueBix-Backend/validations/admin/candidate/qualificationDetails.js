...
exports.validateQualificationDetailsInput = function (data, url = '') {
    let errors = {};
    ...
    // data.qualification_details = eduction_detail;
...
exports.validateQualificationDetails = async function (req, res, url = '') {
    const validateObj = {}
